                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePM" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link text-light loading" href="../../employee/supervisor/department.php">Department Evaluation</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseFB" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-light loading" href="">Report Issue</a>
                                </nav>
                            </div> 
                        </div>
                    </div>
