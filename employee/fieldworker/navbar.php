...
// GENERAL SEARCH
const features = [
    { name: "Dashboard", link: "../../employee/fieldworker/dashboard.php", path: "Employee Dashboard" },
    { name: "Attendance Scanner", link: "../../employee/fieldworker/attendance.php", path: "Time and Attendance/Attendance Scanner" },
    { name: "Evaluation Ratings", link: "../../employee/fieldworker/evaluation.php", path: "Performance Management/Evaluation Ratings" },
    { name: "File Leave", link: "../../employee/fieldworker/leave_file.php", path: "Leave Management/File Leave" },
    { name: "Awardee", link: "../../employee/fieldworker/Awardee.php", path: "Social Recognition/Awardee" },
    { name: "Profile", link: "../../employee/fieldworker/Profile", path: "Profile" },
    { name: "Report Issue", link: "../../employee/fieldworker/report_issue.php", path: "Feedback/Report Issue" }
];
